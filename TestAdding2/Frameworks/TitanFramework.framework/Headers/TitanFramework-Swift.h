...
@interface TitanInitializer (SWIFT_EXTENSION(TitanFramework)) <UNUserNotificationCenterDelegate>
...
@interface TitanInitializer (SWIFT_EXTENSION(TitanFramework)) <CXProviderDelegate>
- (void)provider:(CXProvider * _Nonnull)provider performAnswerCallAction:(CXAnswerCallAction * _Nonnull)action SWIFT_AVAILABILITY(ios,introduced=10.0);
- (void)provider:(CXProvider * _Nonnull)provider performEndCallAction:(CXEndCallAction * _Nonnull)action SWIFT_AVAILABILITY(ios,introduced=10.0);
- (void)providerDidReset:(CXProvider * _Nonnull)provider SWIFT_AVAILABILITY(ios,introduced=10.0);
- (void)providerDidBegin:(CXProvider * _Nonnull)provider SWIFT_AVAILABILITY(ios,introduced=10.0);
@end
...
@interface TitanInitializer (SWIFT_EXTENSION(TitanFramework)) <PKPushRegistryDelegate>
